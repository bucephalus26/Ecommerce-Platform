...
">
    <div class="product">
        ...
        <button onclick="menstrousers1On()" id="menstrousers1On" class="arrow"><img src="images/arrowl.png" alt="" style="width:25px;height:25px"></button>
            <img src="images/menstrousers1.jpg"style="width:100px; height: 200px;"  alt="shirt 1" class="thumbnail" id="menstrousersimg">
            <button class="arrow" onclick="menstrousers1Off()" id="menstrousers1Off"><img src="images/arrowr.png" alt="" style="width:25px;height:25px"></button><br>
            <label>Size :</label>
    ...
    <button class="cart">Add to cart</button>
        ...
        <div>
        <button onclick="menstrousers2On()" id="menstrousers2On" class="arrow"><img src="images/arrowl.png" alt="" style="width:25px;height:25px"></button>
            <img src="images/menstrousers2.jpg"style="width:150px; height:200px;"  alt="shirt 2" class="thumbnail" id="menstrousers2img">
        <button class="arrow" onclick="menstrousers2Off()" id="menstrousers2Off"><img src="images/arrowr.png" alt="" style="width:25px;height:25px"></button><br>
        <label>Size :</label>
        <input type="radio" name="size" value="size"><strong>XS</strong>
        <input type="radio" name="size" value="size"><strong>S </strong>       
        <input type="radio" name="size" value="size"><strong>L </strong>       
    ...
    <button class="cart">Add to cart</button>
        ...
        <div>
        <button onclick="menstrousers3On()" id="menstrousers3On" class="arrow"><img src="images/arrowl.png" alt="" style="width:25px;height:25px"></button>
            <img src="images/menstrousers3.jpg"style="width: 300px; height:200px;"  alt="shirt 2" class="thumbnail" id="menstrousers3img">
            <button class="arrow" onclick="menstrousers3Off()" id="menstrousers3Off"><img src="images/arrowr.png" alt="" style="width:25px;height:25px"></button>
        </div><br>
        <div>
        <label>Size :</label>
        <input type="radio" name="size" value="size"><strong>XS</strong>
    ...
    <img src="frontend/images/shoesorrange.jpg" style="width:150px; height:150px;" alt="shoes3">
        ...
        <!-- <div class="float-container">
            ...
            <script>
                ...
                function menstrousers1Off(){
                  document.getElementById('menstrousersimg').src="images/menstrousers1back.webp";
                  document.getElementById('menstrousers1Off').style.display="none";
                  document.getElementById('menstrousers1On').style.display="inline";
                 }
                function menstrousers1On(){
                  document.getElementById('menstrousersimg').src="images/menstrousers1.jpg";
                  document.getElementById('menstrousers1On').style.display="none";
                  document.getElementById('menstrousers1Off').style.display="inline";
                 }
                


                 function menstrousers2Off(){
                  document.getElementById('menstrousers2img').src="images/tshirtadidasback.jpg";
                  document.getElementById('menstrousers2Off').style.display="none";
                  document.getElementById('menstrousers2On').style.display="inline";
                 }
                 function menstrousers2On(){
                  document.getElementById('menstrousers2img').src="images/menstrousers2.jpg";
                  document.getElementById('menstrousers2On').style.display="none";
                  document.getElementById('menstrousers2Off').style.display="inline";
                 }
               
                 
                 function menstrousers3Off(){
                  document.getElementById('menstrousers3img').src="images/uatshirtback.jpg";
                  document.getElementById('menstrousers3Off').style.display="none";
                  document.getElementById('menstrousers3On').style.display="inline";
                 }
                 function menstrousers3On(){
                  document.getElementById('menstrousers3img').src="images/menstrousers3.jpg";
                  document.getElementById('menstrousers3On').style.display="none";
                  document.getElementById('menstrousers3Off').style.display="inline";
                 }
