...
">
  ...
  rndmSales();
        ...
        <button onclick="top3On()" id="top3On" class="arrow"><img src="images/arrowl.png" alt="" style="width:25px;height:25px"></button>
            <img src="images/top3.jpg"style="width:150px; height:150px;" alt="shirt 1" class="thumbnail" id="top3Img">
    ...
    <h4>Description</h4>
        ...
        <button onclick="adidasOn()" id="adidasOn" class="arrow"><img src="images/arrowl.png" alt="" style="width:25px;height:25px"></button>
            <img src="images/tshirtadidas.jpg"id="adidasShirt"style="width:150px; height:150px;"  alt="shirt 2" class="thumbnail">
        <button class="arrow" onclick="adidasOff()" id="adidasOff"><img src="images/arrowr.png" alt="" style="width:25px;height:25px"></button>
<br>
        <label>Size :</label>
        <input type="radio" name="size" value="size"><strong>XS</strong>
        <input type="radio" name="size" value="size"><strong>S </strong>       
    ...
    <button class="cart">Add to cart</button>
          ...
          <br><br><br><br>
           ...
           <!-- adding products , importing images, adding description and styling the images -->
        <div>
            <button id="underShirtOn" onclick="underShirtOn()" class="arrow"><img src="images/arrowl.png" alt="" style="width:25px;height:25px"></button>
            <img src="images/underarmourtshirt.jpg"style="width:150px; height:150px;" id="underShirtImg"  alt="shirt 2" class="thumbnail">
            <button id="underShirtOff" onclick="underShirtOff()" class="arrow"><img src="images/arrowr.png" alt="" style="width:25px;height:25px"></button>
        </div>
        <div>
